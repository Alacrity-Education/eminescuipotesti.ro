...
export const enum_pages_blocks_cta_variant = pgEnum(
  "enum_pages_blocks_cta_variant",
  ["primary", "starry", "background", "secondary"],
);
...
export const enum_pages_blocks_archive_style = pgEnum(
  "enum_pages_blocks_archive_style",
  ["long"],
);
...
export const enum_pages_blocks_archive_long_card_styles_card1 = pgEnum(
  "enum_pages_blocks_archive_long_card_styles_card1",
  ["primary", "secondary", "starry", "transparent"],
);
export const enum_pages_blocks_archive_long_card_styles_card2 = pgEnum(
  "enum_pages_blocks_archive_long_card_styles_card2",
  ["primary", "secondary", "starry", "transparent"],
);
export const enum_pages_blocks_archive_long_card_styles_card3 = pgEnum(
  "enum_pages_blocks_archive_long_card_styles_card3",
  ["primary", "secondary", "starry", "transparent"],
);
export const enum_pages_blocks_archive_long_card_styles_card4 = pgEnum(
  "enum_pages_blocks_archive_long_card_styles_card4",
  ["primary", "secondary", "starry", "transparent"],
);
...
export const enum__pages_v_blocks_cta_variant = pgEnum(
  "enum__pages_v_blocks_cta_variant",
  ["primary", "starry", "background", "secondary"],
);
...
export const enum__pages_v_blocks_archive_style = pgEnum(
  "enum__pages_v_blocks_archive_style",
  ["long"],
);
...
export const enum__pages_v_blocks_archive_long_card_styles_card1 = pgEnum(
  "enum__pages_v_blocks_archive_long_card_styles_card1",
  ["primary", "secondary", "starry", "transparent"],
);
export const enum__pages_v_blocks_archive_long_card_styles_card2 = pgEnum(
  "enum__pages_v_blocks_archive_long_card_styles_card2",
  ["primary", "secondary", "starry", "transparent"],
);
export const enum__pages_v_blocks_archive_long_card_styles_card3 = pgEnum(
  "enum__pages_v_blocks_archive_long_card_styles_card3",
  ["primary", "secondary", "starry", "transparent"],
);
export const enum__pages_v_blocks_archive_long_card_styles_card4 = pgEnum(
  "enum__pages_v_blocks_archive_long_card_styles_card4",
  ["primary", "secondary", "starry", "transparent"],
);
...
export const enum__pages_v_version_hero_type = pgEnum(
  ...
  ["none", "highImpact", "homeHero", "mediumImpact", "lowImpact"],
);
...
export const enum_footer_sections_links_link_type = pgEnum(
  "enum_footer_sections_links_link_type",
  ["reference", "custom"],
);
...
export const pages_blocks_cta = pgTable(
  "pages_blocks_cta",
  {
    ...
    variant: enum_pages_blocks_cta_variant("variant"),
  ...
  (columns) => [
    ...
    index("pages_blocks_cta_media_idx").on(columns.media),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [pages.id],
...
export const pages_blocks_archive = pgTable(
  "pages_blocks_archive",
  {
    ...
    style: enum_pages_blocks_archive_style("style").default("long"),
    populateBy:
    ...
    longCardStyles_card1: enum_pages_blocks_archive_long_card_styles_card1(
      "long_card_styles_card1",
    ).default("primary"),
    longCardStyles_card2: enum_pages_blocks_archive_long_card_styles_card2(
      "long_card_styles_card2",
    ).default("secondary"),
    longCardStyles_card3: enum_pages_blocks_archive_long_card_styles_card3(
      "long_card_styles_card3",
    ).default("starry"),
    longCardStyles_card4: enum_pages_blocks_archive_long_card_styles_card4(
      "long_card_styles_card4",
    ).default("transparent"),
    blockName: varchar("block_name"),
  },
  (columns) => [
...
export const pages_blocks_card_block_cards = pgTable(
  ...
  (columns) => [
    ...
    index("pages_blocks_card_block_cards_parent_id_idx").on(columns._parentID),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [pages_blocks_card_block.id],
      name: "pages_blocks_card_block_cards_parent_id_fk",
    }).onDelete("cascade"),
  ],
);

export const pages_blocks_card_block = pgTable(
  ...
  (columns) => [
    index("pages_blocks_card_block_order_idx").on(columns._order),
    index("pages_blocks_card_block_parent_id_idx").on(columns._parentID),
    index("pages_blocks_card_block_path_idx").on(columns._path),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [pages.id],
      name: "pages_blocks_card_block_parent_id_fk",
    }).onDelete("cascade"),
  ],
);
...
export const pages_blocks_logo_carousel_logos = pgTable(
  ...
  (columns) => [
    ...
    index("pages_blocks_logo_carousel_logos_parent_id_idx").on(
      columns._parentID,
    ),
    index("pages_blocks_logo_carousel_logos_image_idx").on(columns.image),
    foreignKey({
      columns: [columns["_parentID"]],
...
export const pages_blocks_logo_carousel = pgTable(
  "pages_blocks_logo_carousel",
  {
    ...
    id: varchar("id").primaryKey(),
    title: varchar("title"),
    speed: numeric("speed", { mode: "number" }).default(30),
    gap: numeric("gap", { mode: "number" }).default(24),
    blockName: varchar("block_name"),
  },
  (columns) => [
...
export const pages_blocks_image_content_cells = pgTable(
  "pages_blocks_image_content_cells",
  {
    _order: integer("_order").notNull(),
    _parentID: varchar("_parent_id").notNull(),
    id: varchar("id").primaryKey(),
    type: enum_pages_blocks_image_content_cells_type("type").default("text"),
    spanRows: boolean("span_rows"),
    richText: jsonb("rich_text"),
    media: integer("media_id").references(() => media.id, {
      onDelete: "set null",
    }),
  ...
  (columns) => [
    index("pages_blocks_image_content_cells_order_idx").on(columns._order),
    index("pages_blocks_image_content_cells_parent_id_idx").on(
      columns._parentID,
    ),
    index("pages_blocks_image_content_cells_media_idx").on(columns.media),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [pages_blocks_image_content.id],
      name: "pages_blocks_image_content_cells_parent_id_fk",
    }).onDelete("cascade"),
  ],
);

export const pages_blocks_image_content = pgTable(
  "pages_blocks_image_content",
  {
    _order: integer("_order").notNull(),
    _parentID: integer("_parent_id").notNull(),
    _path: text("_path").notNull(),
  ...
  (columns) => [
    index("pages_blocks_image_content_order_idx").on(columns._order),
    index("pages_blocks_image_content_parent_id_idx").on(columns._parentID),
    index("pages_blocks_image_content_path_idx").on(columns._path),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [pages.id],
      name: "pages_blocks_image_content_parent_id_fk",
    }).onDelete("cascade"),
  ],
);
...
export const _pages_v_blocks_cta = pgTable(
  "_pages_v_blocks_cta",
  {
    ...
    title: varchar("title"),
    richText: jsonb("rich_text"),
    variant: enum__pages_v_blocks_cta_variant("variant"),
    media: integer("media_id").references(() => media.id, {
      onDelete: "set null",
    }),
    _uuid: varchar("_uuid"),
  ...
  (columns) => [
    ...
    index("_pages_v_blocks_cta_media_idx").on(columns.media),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [_pages_v.id],
...
export const _pages_v_blocks_archive = pgTable(
  "_pages_v_blocks_archive",
  {
    ...
    title: varchar("title"),
    introContent: jsonb("intro_content"),
    style: enum__pages_v_blocks_archive_style("style").default("long"),
    populateBy:
    ...
    limit: numeric("limit", { mode: "number" }).default(10),
    longCardStyles_card1: enum__pages_v_blocks_archive_long_card_styles_card1(
      "long_card_styles_card1",
    ).default("primary"),
    longCardStyles_card2: enum__pages_v_blocks_archive_long_card_styles_card2(
      "long_card_styles_card2",
    ).default("secondary"),
    longCardStyles_card3: enum__pages_v_blocks_archive_long_card_styles_card3(
      "long_card_styles_card3",
    ).default("starry"),
    longCardStyles_card4: enum__pages_v_blocks_archive_long_card_styles_card4(
      "long_card_styles_card4",
    ).default("transparent"),
    _uuid: varchar("_uuid"),
    blockName: varchar("block_name"),
...
export const _pages_v_blocks_card_block_cards = pgTable(
  ...
  (columns) => [
    index("_pages_v_blocks_card_block_cards_order_idx").on(columns._order),
    index("_pages_v_blocks_card_block_cards_parent_id_idx").on(
      columns._parentID,
    ),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [_pages_v_blocks_card_block.id],
      name: "_pages_v_blocks_card_block_cards_parent_id_fk",
    }).onDelete("cascade"),
  ],
);

export const _pages_v_blocks_card_block = pgTable(
  ...
  (columns) => [
    index("_pages_v_blocks_card_block_order_idx").on(columns._order),
    index("_pages_v_blocks_card_block_parent_id_idx").on(columns._parentID),
    index("_pages_v_blocks_card_block_path_idx").on(columns._path),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [_pages_v.id],
      name: "_pages_v_blocks_card_block_parent_id_fk",
    }).onDelete("cascade"),
  ],
);
...
export const _pages_v_blocks_logo_carousel_logos = pgTable(
  ...
  (columns) => [
    ...
    index("_pages_v_blocks_logo_carousel_logos_parent_id_idx").on(
      columns._parentID,
    ),
    index("_pages_v_blocks_logo_carousel_logos_image_idx").on(columns.image),
    foreignKey({
      columns: [columns["_parentID"]],
...
export const _pages_v_blocks_image_content_cells = pgTable(
  "_pages_v_blocks_image_content_cells",
  {
    _order: integer("_order").notNull(),
    _parentID: integer("_parent_id").notNull(),
    id: serial("id").primaryKey(),
    type: enum__pages_v_blocks_image_content_cells_type("type").default("text"),
    spanRows: boolean("span_rows"),
    richText: jsonb("rich_text"),
    media: integer("media_id").references(() => media.id, {
      onDelete: "set null",
  ...
  (columns) => [
    index("_pages_v_blocks_image_content_cells_order_idx").on(columns._order),
    index("_pages_v_blocks_image_content_cells_parent_id_idx").on(
      columns._parentID,
    ),
    index("_pages_v_blocks_image_content_cells_media_idx").on(columns.media),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [_pages_v_blocks_image_content.id],
      name: "_pages_v_blocks_image_content_cells_parent_id_fk",
    }).onDelete("cascade"),
  ],
);

export const _pages_v_blocks_image_content = pgTable(
  "_pages_v_blocks_image_content",
  {
    _order: integer("_order").notNull(),
    _parentID: integer("_parent_id").notNull(),
    _path: text("_path").notNull(),
  ...
  (columns) => [
    index("_pages_v_blocks_image_content_order_idx").on(columns._order),
    index("_pages_v_blocks_image_content_parent_id_idx").on(columns._parentID),
    index("_pages_v_blocks_image_content_path_idx").on(columns._path),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [_pages_v.id],
      name: "_pages_v_blocks_image_content_parent_id_fk",
    }).onDelete("cascade"),
  ],
);
...
export const footer_sections_links = pgTable(
  "footer_sections_links",
  {
    ...
    id: varchar("id").primaryKey(),
    link_type:
      enum_footer_sections_links_link_type("link_type").default("reference"),
    link_newTab: boolean("link_new_tab"),
    link_url: varchar("link_url"),
    link_label: varchar("link_label").notNull(),
  },
  (columns) => [
    index("footer_sections_links_order_idx").on(columns._order),
    index("footer_sections_links_parent_id_idx").on(columns._parentID),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [footer_sections.id],
      name: "footer_sections_links_parent_id_fk",
    }).onDelete("cascade"),
  ],
);

export const footer_sections = pgTable(
  "footer_sections",
  {
    _order: integer("_order").notNull(),
    _parentID: integer("_parent_id").notNull(),
    id: varchar("id").primaryKey(),
    title: varchar("title").notNull(),
    colStartLg: numeric("col_start_lg", { mode: "number" }),
  },
  (columns) => [
    index("footer_sections_order_idx").on(columns._order),
    index("footer_sections_parent_id_idx").on(columns._parentID),
    foreignKey({
      columns: [columns["_parentID"]],
      foreignColumns: [footer.id],
      name: "footer_sections_parent_id_fk",
    }).onDelete("cascade"),
  ],
);
...
export const footer = pgTable(
  "footer",
  {
    ...
    credit: varchar("credit").default("Dezvoltat de Alacrity Education"),
    updatedAt: timestamp("updated_at", {
      mode: "string",
      withTimezone: true,
      precision: 3,
...
export const relations_pages_blocks_card_block_cards = relations(
  pages_blocks_card_block_cards,
  ({ one }) => ({
    _parentID: one(pages_blocks_card_block, {
      fields: [pages_blocks_card_block_cards._parentID],
      references: [pages_blocks_card_block.id],
      relationName: "cards",
    }),
  }),
);
export const relations_pages_blocks_card_block = relations(
  pages_blocks_card_block,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_card_block._parentID],
      references: [pages.id],
      relationName: "_blocks_cardBlock",
    }),
    cards: many(pages_blocks_card_block_cards, {
      relationName: "cards",
    }),
  }),
);
export const relations_pages_blocks_logo_carousel_logos = relations(
  ...
  ({ one }) => ({
    ...
    image: one(media, {
      fields: [pages_blocks_logo_carousel_logos.image],
      references: [media.id],
      relationName: "image",
    }),
  }),
...
export const relations_pages_blocks_image_content_cells = relations(
  pages_blocks_image_content_cells,
  ({ one }) => ({
    _parentID: one(pages_blocks_image_content, {
      fields: [pages_blocks_image_content_cells._parentID],
      references: [pages_blocks_image_content.id],
      relationName: "cells",
    }),
    media: one(media, {
      fields: [pages_blocks_image_content_cells.media],
      references: [media.id],
      relationName: "media",
    }),
  }),
);
export const relations_pages_blocks_image_content = relations(
  pages_blocks_image_content,
  ({ one, many }) => ({
    _parentID: one(pages, {
      fields: [pages_blocks_image_content._parentID],
      references: [pages.id],
      relationName: "_blocks_imageContent",
    }),
    cells: many(pages_blocks_image_content_cells, {
      relationName: "cells",
    }),
  }),
);
...
export const relations_pages = relations(pages, ({ one, many }) => ({
  ...
  _blocks_cardBlock: many(pages_blocks_card_block, {
    relationName: "_blocks_cardBlock",
  }),
  _blocks_logoCarousel: many(pages_blocks_logo_carousel, {
    relationName: "_blocks_logoCarousel",
  }),
  _blocks_imageContent: many(pages_blocks_image_content, {
    relationName: "_blocks_imageContent",
  }),
...
export const relations__pages_v_blocks_cta = relations(
  ...
  ({ one, many }) => ({
    ...
    media: one(media, {
      fields: [_pages_v_blocks_cta.media],
      references: [media.id],
      relationName: "media",
    }),
...
export const relations__pages_v_blocks_card_block_cards = relations(
  _pages_v_blocks_card_block_cards,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_card_block, {
      fields: [_pages_v_blocks_card_block_cards._parentID],
      references: [_pages_v_blocks_card_block.id],
      relationName: "cards",
    }),
  }),
);
export const relations__pages_v_blocks_card_block = relations(
  _pages_v_blocks_card_block,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_card_block._parentID],
      references: [_pages_v.id],
      relationName: "_blocks_cardBlock",
    }),
    cards: many(_pages_v_blocks_card_block_cards, {
      relationName: "cards",
    }),
  }),
);
export const relations__pages_v_blocks_logo_carousel_logos = relations(
  ...
  ({ one }) => ({
    ...
    image: one(media, {
      fields: [_pages_v_blocks_logo_carousel_logos.image],
      references: [media.id],
      relationName: "image",
    }),
  }),
...
export const relations__pages_v_blocks_image_content_cells = relations(
  _pages_v_blocks_image_content_cells,
  ({ one }) => ({
    _parentID: one(_pages_v_blocks_image_content, {
      fields: [_pages_v_blocks_image_content_cells._parentID],
      references: [_pages_v_blocks_image_content.id],
      relationName: "cells",
    }),
    media: one(media, {
      fields: [_pages_v_blocks_image_content_cells.media],
      references: [media.id],
      relationName: "media",
    }),
  }),
);
export const relations__pages_v_blocks_image_content = relations(
  _pages_v_blocks_image_content,
  ({ one, many }) => ({
    _parentID: one(_pages_v, {
      fields: [_pages_v_blocks_image_content._parentID],
      references: [_pages_v.id],
      relationName: "_blocks_imageContent",
    }),
    cells: many(_pages_v_blocks_image_content_cells, {
      relationName: "cells",
    }),
  }),
);
...
export const relations__pages_v = relations(_pages_v, ({ one, many }) => ({
  ...
  _blocks_cardBlock: many(_pages_v_blocks_card_block, {
    relationName: "_blocks_cardBlock",
  }),
  _blocks_logoCarousel: many(_pages_v_blocks_logo_carousel, {
    relationName: "_blocks_logoCarousel",
  }),
  _blocks_imageContent: many(_pages_v_blocks_image_content, {
    relationName: "_blocks_imageContent",
  }),
...
export const relations_footer_sections_links = relations(
  footer_sections_links,
  ({ one }) => ({
    _parentID: one(footer_sections, {
      fields: [footer_sections_links._parentID],
      references: [footer_sections.id],
      relationName: "links",
    }),
  }),
);
export const relations_footer_sections = relations(
  footer_sections,
  ({ one, many }) => ({
    _parentID: one(footer, {
      fields: [footer_sections._parentID],
      references: [footer.id],
      relationName: "sections",
    }),
    links: many(footer_sections_links, {
      relationName: "links",
    }),
  }),
);
...
type DatabaseSchema = {
  ...
  enum_pages_blocks_archive_style: typeof enum_pages_blocks_archive_style;
  ...
  enum_pages_blocks_archive_long_card_styles_card1: typeof enum_pages_blocks_archive_long_card_styles_card1;
  enum_pages_blocks_archive_long_card_styles_card2: typeof enum_pages_blocks_archive_long_card_styles_card2;
  enum_pages_blocks_archive_long_card_styles_card3: typeof enum_pages_blocks_archive_long_card_styles_card3;
  enum_pages_blocks_archive_long_card_styles_card4: typeof enum_pages_blocks_archive_long_card_styles_card4;
  enum_pages_blocks_card_block_cards_variant: typeof enum_pages_blocks_card_block_cards_variant;
  enum_pages_blocks_image_content_cells_type: typeof enum_pages_blocks_image_content_cells_type;
  ...
  enum__pages_v_blocks_archive_style: typeof enum__pages_v_blocks_archive_style;
  ...
  enum__pages_v_blocks_archive_long_card_styles_card1: typeof enum__pages_v_blocks_archive_long_card_styles_card1;
  enum__pages_v_blocks_archive_long_card_styles_card2: typeof enum__pages_v_blocks_archive_long_card_styles_card2;
  enum__pages_v_blocks_archive_long_card_styles_card3: typeof enum__pages_v_blocks_archive_long_card_styles_card3;
  enum__pages_v_blocks_archive_long_card_styles_card4: typeof enum__pages_v_blocks_archive_long_card_styles_card4;
  enum__pages_v_blocks_card_block_cards_variant: typeof enum__pages_v_blocks_card_block_cards_variant;
  enum__pages_v_blocks_image_content_cells_type: typeof enum__pages_v_blocks_image_content_cells_type;
  ...
  enum_footer_sections_links_link_type: typeof enum_footer_sections_links_link_type;
  ...
  pages_blocks_card_block_cards: typeof pages_blocks_card_block_cards;
  pages_blocks_card_block: typeof pages_blocks_card_block;
  ...
  pages_blocks_image_content_cells: typeof pages_blocks_image_content_cells;
  pages_blocks_image_content: typeof pages_blocks_image_content;
  pages: typeof pages;
  ...
  _pages_v_blocks_card_block_cards: typeof _pages_v_blocks_card_block_cards;
  _pages_v_blocks_card_block: typeof _pages_v_blocks_card_block;
  ...
  _pages_v_blocks_image_content_cells: typeof _pages_v_blocks_image_content_cells;
  _pages_v_blocks_image_content: typeof _pages_v_blocks_image_content;
  ...
  footer_sections_links: typeof footer_sections_links;
  footer_sections: typeof footer_sections;
  ...
  relations_pages_blocks_card_block_cards: typeof relations_pages_blocks_card_block_cards;
  relations_pages_blocks_card_block: typeof relations_pages_blocks_card_block;
  ...
  relations_pages_blocks_image_content_cells: typeof relations_pages_blocks_image_content_cells;
  relations_pages_blocks_image_content: typeof relations_pages_blocks_image_content;
  ...
  relations__pages_v_blocks_card_block_cards: typeof relations__pages_v_blocks_card_block_cards;
  relations__pages_v_blocks_card_block: typeof relations__pages_v_blocks_card_block;
  ...
  relations__pages_v_blocks_image_content_cells: typeof relations__pages_v_blocks_image_content_cells;
  relations__pages_v_blocks_image_content: typeof relations__pages_v_blocks_image_content;
  ...
  relations_footer_sections_links: typeof relations_footer_sections_links;
  relations_footer_sections: typeof relations_footer_sections;
